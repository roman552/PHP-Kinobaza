...
class Movies extends MY_Controller {
    ...
    public function view($slug = NULL) {
        ...
        $this->data['descriptions_movie'] = $movie_slug['description'];
    ...
    public function type($slug = NULL) {
        ...
        $p_config['cur_tag_close'] = '<span class="sr-only"></span></li>';
    ...
    public function create() {
        ...
        if($this->input->post('slug') && $this->input->post('name') && $this->input->post('descriptions') && $this->input->post('year') && $this->input->post('rating') 
        && $this->input->post('poster') && $this->input->post('player_code') && $this->input->post('director') && $this->input->post('add_date') && $this->input->post('category_id')) {
