...
class Posts extends MY_Controller {
    ...
    public function create() {
        ...
        if($this->input->post('slug') && $this->input->post('title') && $this->input->post('text')) {
            ...
            if($this->Posts_model->setPosts($slug, $title, $text)) {
                $this->data['title'] = 'Пост добавлена!';
                $this->load->view('templates/header', $this->data);
    ...
    public function edit($slug = NULL) {
        ...
        $this->['id_posts'] = $this->data['posts_item']['id'];
        $this->['title_posts'] = $this->data['posts_item']['title'];
        $this->['content_posts'] = $this->data['posts_item']['text'];
        $this->['slug_posts'] = $this->data['posts_item']['slug'];
